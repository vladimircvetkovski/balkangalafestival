	...
	function widget($args, $instance)
	{
		...
		if($screen_name) { ?>
			...
			jQuery(document).ready(function($) {	 			   
				...
				$.getJSON("//api.flickr.com/services/feeds/photos_public.gne?id=<?php echo esc_attr( $screen_name); ?>&lang=en-us&format=json&jsoncallback=?", displayImages);  //YOUR IDGETTR GOES HERE
